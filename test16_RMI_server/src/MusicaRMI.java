...
public class MusicaRMI extends UnicastRemoteObject implements MusicaInterfaceRMI {
	...
	@Override public String buscarTitulo(String titulo) throws RemoteException {
		String resultado = "";
	...
	@Override public String buscarBanda(String banda) throws RemoteException {
		String resultado = "";
		for (Cancion c: canciones) {
	...
	@Override public String buscarAlbum(String album) throws RemoteException {
		String resultado = "";
		for (Cancion c: canciones) {
	...
	@Override public String buscarProducido(int a) throws RemoteException {
		String resultado = "";
		for (Cancion c: canciones) {
			if (c.getProducido() == a) {
				resultado = resultado + c + "\n";
