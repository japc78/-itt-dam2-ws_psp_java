...
// STUDY El objeto stub que se generarรก en el cliente tiene que extender de Remote para que pueda ser casteado ya que la busqueda de objetos en el registro devuelve un objeto de tipo Remote (ver la parte de cliente)
