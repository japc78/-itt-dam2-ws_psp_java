...
// STUDY UnicastRemoteObject, lo que permitirá a los clientes obtener el stub del objeto para establecer la comunicación y poder invocar a los métodos remotos.
public class MusicaRMI extends UnicastRemoteObject implements MusicaInterfaceRMI,Serializable {
		//La interface Serializable es lo que va a permitir salir el objeto de la JMV donde se encuentre.
